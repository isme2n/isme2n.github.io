...
직종마다 공부의 방법은 조금씩 다를 수 있어도 공부는 항상 따라오게 되는 요소이다.
...
해야 할 일을 마치고 자리에 돌아왔을 때 나를 반기는 책을 보면, 공부를 안하고는 못 베길거다.

### 의무감을 가져라.

하루에 한시간은 무조건 공부한다는 생각으로 해라. 사실 공부는 책상에 앉아서 하는 시간만이 공부하는 시간은 아니다. 대변을 보면서도 단어를 외울 수 있다.
